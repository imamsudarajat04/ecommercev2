    ...
    <!-- Bootstrap select-->
    <link rel="stylesheet" href="{{ asset('asset/vendor/bootstrap-select/css/bootstrap-select.min.css') }}">
    <!-- Owl Carousel-->
    <link rel="stylesheet" href="{{ asset('asset/vendor/owl.carousel2/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/vendor/owl.carousel2/assets/owl.theme.default.css') }}">
    <!-- Google fonts-->
